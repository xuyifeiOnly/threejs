      ...
      if (child.name.includes('Tire')) {
        switch (child.name) {
          ...
          case 'Tire_19':
            ...
            let webglContext = refRenderer.getContext('webgl')
            let supportedExtensions = webglContext.getSupportedExtensions()
...
var Tire_A02_pvr = LoadTextureCorrected(
  mKTXLoader,
  'data/lynkco09/texture/Tire_A02-pvr.ktx'
)
var Tire_N02_pvr = LoadTextureCorrected(
  mKTXLoader,
  'data/lynkco09/texture/Tire_N02-pvr.ktx'
)
var Tire_A02_etc1 = LoadTextureCorrected(
  mKTXLoader,
  'data/lynkco09/texture/Tire_A02-etc1.ktx'
)
var Tire_N02_etc1 = LoadTextureCorrected(
  mKTXLoader,
  'data/lynkco09/texture/Tire_N02-etc1.ktx'
)
...
export const Mt_Body = new THREE.MeshStandardMaterial({
  name: 'Mt_Body',
  color: dfCol_Body,
  roughness: 0.0,
  metalness: 0.0,
